...
@NgModule({
  declarations: [ClientsComponent, ActionsComponent, ReadingsComponent, PaymentsComponent, RegisterReadingComponent],
  imports: [CommonModule, ConsumerRoutingModule, MaterialModule],
})
